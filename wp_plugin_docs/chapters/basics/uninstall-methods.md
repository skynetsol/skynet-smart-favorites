...
Scenario Deactivation Hook Uninstall Hook Flush Cache/Temp Yes No Flush Permalinks Yes No Remove Options from {$ wpdb ->prefix}_options No Yes Remove Tables from wpdb No Yes 
