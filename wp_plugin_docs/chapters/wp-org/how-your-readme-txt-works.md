...
You can embed videos from YouTube, Vimeo, and anywhere else WordPress supports by default . All you have to do is paste the video URL onto it’s own line in your readme. 
...
- Author and Plugin Homepages The Author URI and Plugin URI fields of the plugin header. The Plugin URI should be unique to each plugin. Do not use the same URI for your free and pro plugin. It ends badly. 
